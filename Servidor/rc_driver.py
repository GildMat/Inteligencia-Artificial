...
class SensorDataHandler(socketserver.BaseRequestHandler):
    ...
    def handle(self):
        ...
        while self.data:
            ...
            print("DISTANCIA SENSOR: "+str(sensor_data))


class VideoStreamHandler(socketserver.StreamRequestHandler):

    # h1: señal de stop, medida manualmente # h1: stop sign, measured manually
    # h2: semáforo, medido manualmente      # h2: traffic light, measured manually
    h1 = 5.5  # cm
    h2 = 5.5

    # load trained neural network
    nn = NeuralNetwork()
    nn.load_model("computer/nn_model.xml")

    obj_detection = ObjectDetection()
    #rc_car = RCControl("/dev/tty.usbmodem1421")#CODIGO ORIGINAL
    rc_car = RCControl("com11")



    # cascade classifiers
    stop_cascade = cv2.CascadeClassifier("computer/cascade_xml/stop_sign.xml")
    light_cascade = cv2.CascadeClassifier("computer/cascade_xml/traffic_light.xml")

    d_to_camera = DistanceToCamera()
    # umbrales codificados para detenerse, sensor de 30 cm, otros dos de 25 cm # hard coded thresholds for stopping, sensor 30cm, other two 25cm
    d_sensor_thresh = 30
    d_stop_light_thresh = 65 #25
        ...
        try:
            ...
            while True:
                ...
                if first != -1 and last != -1:
                    ...
                    elif 0 < self.d_light and (self.obj_detection.red_light or self.obj_detection.green_light): #< self.d_stop_light_thresh:
                        print("Traffic light ahead")
                        #print("#############################")
                        #print(str(self.obj_detection.red_light)+" "+str(self.obj_detection.yellow_light)+" "+str(self.obj_detection.green_light))
                        #print("-----------------------------")
...
if __name__ == '__main__':
    h, p1, p2 = "192.168.1.38", 8000, 8002
